...
public class JointTrajectory extends frc.team88.ros.messages.RosMessage {
    ...
    public JointTrajectory(frc.team88.ros.messages.std_msgs.Header header, java.lang.String[] joint_names, frc.team88.ros.messages.trajectory_msgs.JointTrajectoryPoint[] points) {
        this.header = header;
