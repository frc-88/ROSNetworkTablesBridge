...
public class JointTrajectory extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "trajectory_msgs/JointTrajectory";

    public JointTrajectory() {

    }

    public JointTrajectory(frc.team88.ros.messages.std_msgs.Header header, String[] joint_names, frc.team88.ros.messages.trajectory_msgs.JointTrajectoryPoint[] points) {
        this.header = header;
