...
public class InteractiveMarkerFeedback extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "visualization_msgs/InteractiveMarkerFeedback";

    public InteractiveMarkerFeedback() {

    }

    public InteractiveMarkerFeedback(frc.team88.ros.messages.std_msgs.Header header, String client_id, String marker_name, String control_name, char event_type, frc.team88.ros.messages.geometry_msgs.Pose pose, int menu_entry_id, frc.team88.ros.messages.geometry_msgs.Point mouse_point, boolean mouse_point_valid) {
        this.header = header;
