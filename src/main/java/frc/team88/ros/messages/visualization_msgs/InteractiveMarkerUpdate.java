...
public class InteractiveMarkerUpdate extends frc.team88.ros.messages.RosMessage {
    ...
    private ArrayList<String> erases = new ArrayList<>();

    @Expose(serialize = false, deserialize = false)
    public final String _type = "visualization_msgs/InteractiveMarkerUpdate";

    public InteractiveMarkerUpdate() {

    }

    public InteractiveMarkerUpdate(String server_id, long seq_num, char type, frc.team88.ros.messages.visualization_msgs.InteractiveMarker[] markers, frc.team88.ros.messages.visualization_msgs.InteractiveMarkerPose[] poses, String[] erases) {
    ...
    public ArrayList<String> getErases() {
        return this.erases;
    }
    ...
    public void setErases(ArrayList<String> erases) {
        this.erases = erases;
    }
