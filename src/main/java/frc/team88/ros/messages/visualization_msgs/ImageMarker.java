...
public class ImageMarker extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "visualization_msgs/ImageMarker";

    public ImageMarker() {

    }

    public ImageMarker(frc.team88.ros.messages.std_msgs.Header header, String ns, int id, int type, int action, frc.team88.ros.messages.geometry_msgs.Point position, float scale, frc.team88.ros.messages.std_msgs.ColorRGBA outline_color, char filled, frc.team88.ros.messages.std_msgs.ColorRGBA fill_color, frc.team88.ros.messages.Duration lifetime, frc.team88.ros.messages.geometry_msgs.Point[] points, frc.team88.ros.messages.std_msgs.ColorRGBA[] outline_colors) {
        this.header = header;
        this.ns = ns;
        this.id = id;
        this.type = type;
