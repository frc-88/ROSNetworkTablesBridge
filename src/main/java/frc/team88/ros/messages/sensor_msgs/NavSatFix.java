...
public class NavSatFix extends frc.team88.ros.messages.RosMessage {
    ...
    private Double[] position_covariance = new Double[] {
        0.0,
        0.0,
        0.0,
        0.0,
    ...
    private char position_covariance_type = '';

    @Expose(serialize = false, deserialize = false)
    public final String _type = "sensor_msgs/NavSatFix";

    public NavSatFix() {

    }

    public NavSatFix(frc.team88.ros.messages.std_msgs.Header header, frc.team88.ros.messages.sensor_msgs.NavSatStatus status, double latitude, double longitude, double altitude, Double[] position_covariance, char position_covariance_type) {
        this.header = header;
        this.status = status;
    ...
    public void setPositionCovariance(Double[] position_covariance) {
