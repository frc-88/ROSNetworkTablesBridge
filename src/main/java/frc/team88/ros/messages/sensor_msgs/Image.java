...
public class Image extends frc.team88.ros.messages.RosMessage {
    ...
    private char is_bigendian = '';
    private int step = 0;
    private ArrayList<Char> data = new ArrayList<>();

    @Expose(serialize = false, deserialize = false)
    public final String _type = "sensor_msgs/Image";

    public Image() {

    }

    public Image(frc.team88.ros.messages.std_msgs.Header header, int height, int width, String encoding, char is_bigendian, int step, Char[] data) {
        this.header = header;
        this.height = height;
        this.width = width;
