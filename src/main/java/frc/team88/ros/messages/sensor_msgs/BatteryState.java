...
public class BatteryState extends frc.team88.ros.messages.RosMessage {
    ...
    private char power_supply_status = '';
    private char power_supply_health = '';
    private char power_supply_technology = '';
    private boolean present = false;
    private ArrayList<Float> cell_voltage = new ArrayList<>();
    private ArrayList<Float> cell_temperature = new ArrayList<>();
    private String location = "";
    private String serial_number = "";

    @Expose(serialize = false, deserialize = false)
    public final String _type = "sensor_msgs/BatteryState";

    public BatteryState() {

    }

    public BatteryState(frc.team88.ros.messages.std_msgs.Header header, float voltage, float temperature, float current, float charge, float capacity, float design_capacity, float percentage, char power_supply_status, char power_supply_health, char power_supply_technology, boolean present, Float[] cell_voltage, Float[] cell_temperature, String location, String serial_number) {
        this.header = header;
    ...
    public ArrayList<Float> getCellVoltage() {
        return this.cell_voltage;
    }
    public ArrayList<Float> getCellTemperature() {
    ...
    public void setCellVoltage(ArrayList<Float> cell_voltage) {
        this.cell_voltage = cell_voltage;
    }
    public void setCellTemperature(ArrayList<Float> cell_temperature) {
