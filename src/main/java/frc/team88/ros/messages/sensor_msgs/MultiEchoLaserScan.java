...
public class MultiEchoLaserScan extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "sensor_msgs/MultiEchoLaserScan";

    public MultiEchoLaserScan() {

    }

    public MultiEchoLaserScan(frc.team88.ros.messages.std_msgs.Header header, float angle_min, float angle_max, float angle_increment, float time_increment, float scan_time, float range_min, float range_max, frc.team88.ros.messages.sensor_msgs.LaserEcho[] ranges, frc.team88.ros.messages.sensor_msgs.LaserEcho[] intensities) {
        this.header = header;
