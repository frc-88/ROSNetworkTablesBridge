...
public class Int8MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "std_msgs/Int8MultiArray";

    public Int8MultiArray() {

    }

    public Int8MultiArray(frc.team88.ros.messages.std_msgs.MultiArrayLayout layout, Byte[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public Int8MultiArray(JsonObject jsonObj) {
