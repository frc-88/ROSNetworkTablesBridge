...
public class RosUInt8MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosUInt8MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Byte[] data) {
        this.layout = layout;
