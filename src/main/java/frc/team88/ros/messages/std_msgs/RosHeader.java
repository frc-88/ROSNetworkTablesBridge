...
public class RosHeader extends frc.team88.ros.messages.RosMessage {
    ...
    public RosHeader(int seq, frc.team88.ros.messages.TimePrimitive stamp, java.lang.String frame_id) {
        this.seq = seq;
        this.stamp = stamp;
