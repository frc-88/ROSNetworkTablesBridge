...
public class RosInt32MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosInt32MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Integer[] data) {
        this.layout = layout;
