...
public class RosUInt32MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosUInt32MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Integer[] data) {
        this.layout = layout;
