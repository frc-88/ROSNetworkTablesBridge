...
public class RosUInt64MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosUInt64MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Long[] data) {
        this.layout = layout;
