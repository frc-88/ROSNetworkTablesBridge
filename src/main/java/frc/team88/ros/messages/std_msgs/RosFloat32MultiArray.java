...
public class RosFloat32MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosFloat32MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Float[] data) {
        this.layout = layout;
