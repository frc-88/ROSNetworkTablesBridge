...
public class Int16MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "std_msgs/Int16MultiArray";

    public Int16MultiArray() {

    }

    public Int16MultiArray(frc.team88.ros.messages.std_msgs.MultiArrayLayout layout, Short[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public Int16MultiArray(JsonObject jsonObj) {
