...
public class Int64MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "std_msgs/Int64MultiArray";

    public Int64MultiArray() {

    }

    public Int64MultiArray(frc.team88.ros.messages.std_msgs.MultiArrayLayout layout, Long[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public Int64MultiArray(JsonObject jsonObj) {
