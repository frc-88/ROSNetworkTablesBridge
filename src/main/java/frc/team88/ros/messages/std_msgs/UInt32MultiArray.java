...
public class UInt32MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public final String _type = "std_msgs/UInt32MultiArray";

    public UInt32MultiArray() {

    }

    public UInt32MultiArray(frc.team88.ros.messages.std_msgs.MultiArrayLayout layout, Int[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public UInt32MultiArray(JsonObject jsonObj) {
