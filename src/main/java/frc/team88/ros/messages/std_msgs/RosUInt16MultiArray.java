...
public class RosUInt16MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosUInt16MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Short[] data) {
        this.layout = layout;
