...
public class RosInt16MultiArray extends frc.team88.ros.messages.RosMessage {
    ...
    public RosInt16MultiArray(frc.team88.ros.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Short[] data) {
        this.layout = layout;
