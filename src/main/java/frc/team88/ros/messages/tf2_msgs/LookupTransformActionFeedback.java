...
public class LookupTransformActionFeedback extends frc.team88.ros.messages.RosMessage {
    ...
    public LookupTransformActionFeedback(frc.team88.ros.messages.std_msgs.Header header, frc.team88.ros.messages.actionlib_msgs.GoalStatus status, frc.team88.ros.messages.tf2_msgs.LookupTransformFeedback feedback) {
        this.header = header;
        this.status = status;
